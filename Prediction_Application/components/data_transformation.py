...
# Feature Engineering
# scaling, filling missing values , one hot, Outliers handling, Imbalanced Data Handling, Feature Selection, 
# Data distribution, -> 
...
# xyz to Weather: ["Clear", "Cloudy","Broken","Few","Scattered","Haze","Fog","Drizzle",
 #                     "Snowfall","Light","Rain","Thunderstorm","Heavy"] 
    ...
    def data_clean(self,data):
        try:
            ...
            # Cleaning the columns for model building # 5Â°C -> 5A and oC -> 15Â°C
